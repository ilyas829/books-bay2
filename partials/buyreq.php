...
<div class="modal fade" id="buyrequestmodal" tabindex="-1" role="dialog" aria-labelledby="buyrequestmodalTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <button type="submit" class="btn btn-primary mr-1 mb-2" id="reqsubmit">Submit request</button>
            <button type="button" class="btn btn-danger ml-3 mb-2" data-dismiss="modal">Close</button>
            </div>
        </div>
