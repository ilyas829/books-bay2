...
/* ============ desktop view .end// ============ */
  ...
  echo'<form class="form-inline my-2 my-lg-0"  method="get" action="search.php">
  <input class="form-control mr-sm-3 lg" type="search" placeholder="Search" aria-label="Search" name="search">
  <button class="btn btn-success my-2 my-sm-0 mr-2" type="submit">Search</button>
</form>
  <button class="btn btn-warning ml-2" data-toggle="modal" data-target="#loginmodal">Login</button>
